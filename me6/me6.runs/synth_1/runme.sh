...
HD_PWD='/home/ebonifacio/Workspace/CoE111/me6/me6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_rom.tcl
